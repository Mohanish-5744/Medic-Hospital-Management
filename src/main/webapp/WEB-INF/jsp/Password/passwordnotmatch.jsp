...
<html>
    <head>
        ...
        <script>
            function sendMail()
            {
                ...
                const serviceID = "service_t9t1dc8";
                const templateID = "template_i6aucra";
        ...
        <script type="text/javascript">
            (function () {
                emailjs.init("19QD217vcpdt49g_9");
            })();
        </script>
    </head>
    ...
    <body>
        ...
        <form action="otpadmin"><button class="btn" >OTP</button></form>
    </body>
</html>-->
            ...
            <div class="auth-form-wrapper">
                ...
                <div class="auth-form">
                    <div class="auth-form-label">
                        <h2>Password or email not match try </h2>
                        <br>
                        <br>
                        <br>
                        <h2>again!</h2>
                    ...
                    <form action="login">
                        ...
                        <input type='text' class='form-control' name="confirmation" placeholder="confirm your password" required/>
